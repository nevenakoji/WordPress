...
jQuery(document).ready(function(){jQuery('.wpcf7-form').each(function(){var repeater_count=jQuery(this).find('.uacf7-repeater-count').val();var total_steps=jQuery(uacf7_step,this).length;var uacf7_sid=1;var form_id=jQuery(this).find("input[name=_wpcf7]").val();var uacf7_next=jQuery(this).find('.uacf7-next[data-form-id="'+form_id+'"]');var uacf7_prev=jQuery(this).find('.uacf7-prev[data-form-id="'+form_id+'"]');var uacf7_step='.uacf7-step-'+form_id;jQuery(uacf7_step,this).each(function(){var $this=jQuery(this);$this.attr('id',form_id+'step-'+uacf7_sid);if(uacf7_sid==1){$this.addClass('step-start')}
if(total_steps==uacf7_sid){$this.addClass('step-end')}
uacf7_sid++});uacf7_prev.on('click',function(e){e.preventDefault()});uacf7_next.on('click',function(e){e.preventDefault();var $this=jQuery(this);uacf7_step_validation($this,uacf7_step,form_id,repeater_count)})});function uacf7_step_validation($this,uacf7_step,form_id,repeater_count){var uacf7_current_step=jQuery($this).closest(uacf7_step);var uacf7_current_step_fields=uacf7_current_step.find('.wpcf7-form-control:not(.uacf7-hidden .wpcf7-form-control, span.wpcf7-form-control)').map(function(){var nameIndex=this.name.indexOf('[]');if(nameIndex!==-1){var fieldName=this.name.replace('[]','')}else{var fieldName=this.name}
...
var uacf7_current_step_fields=uacf7_current_step_fields.filter(uacf7_onlyUnique);var uacf7_form_ids='';var fields_to_check_serialized=jQuery(uacf7_current_step).find(".wpcf7-form-control").serialize();if(jQuery(uacf7_current_step).find(".wpcf7-form-control[type='file']").length>0){jQuery(uacf7_current_step).find(".wpcf7-form-control[type='file']").each(function(i,n){fields_to_check_serialized+="&"+jQuery(this).attr('name')+"="+jQuery(this).val()})}
var validation_fields=[];for(let i=0;i<uacf7_current_step_fields.length;i++){var type=jQuery("input[name="+uacf7_current_step_fields[i]+"]").attr('type');if(typeof repeater_count!='undefined'){var value=jQuery("input[name="+uacf7_current_step_fields[i]+"]").val();if(value==''){validation_fields.push(''+type+':'+uacf7_current_step_fields[i]+'')}}else{validation_fields.push(''+type+':'+uacf7_current_step_fields[i]+'')}}
